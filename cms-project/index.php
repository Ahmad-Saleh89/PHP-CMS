        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                // select data from posts table in database:
                    $query = "SELECT * FROM posts WHERE post_status = 'Published' ORDER BY post_id DESC LIMIT $posts_offset, 5 ";
                ...
                <ul class="pager">
                    <?php
                        for($i = 1; $i <= $count; $i++){ 
                            if($i == $page){
                                echo "<li style='margin-right: 8px'><a href='index.php?page={$i}' class='active_link'>{$i}</a></li>";
                            }else{
                                echo "<li style='margin-right: 8px'><a href='index.php?page={$i}'>{$i}</a></li>";
                            }
                        }
                    ?>
                </ul>
